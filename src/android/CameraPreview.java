...
public class CameraPreview extends CordovaPlugin implements CameraActivity.CameraPreviewListener {
	...
	private boolean startCamera(int x, int y, int width, int height, String defaultCamera, Boolean tapToTakePicture, Boolean dragEnabled, final Boolean toBack, String alpha, boolean tapFocus, boolean disableExifHeaderStripping, boolean storeToFile, boolean disableShutterSound, CallbackContext callbackContext) {
		...
		fragment.toBack = toBack;
		fragment.disableShutterSound = disableShutterSound;
