...
* `camera` - See [CAMERA_DIRECTION](#camera_direction) - Defaults to front camera
...
Get focus modes supported by the camera device currently started. Returns an array containing supported focus modes. See [FOCUS_MODE](#focus_mode) for possible values that can be returned.
...
Set the focus mode for the camera device currently started. See [FOCUS_MODE](#focus_mode) for a list of possible values.
...
Get the focus mode for the camera device currently started. Returns a string representing the current focus mode. See [FOCUS_MODE](#focus_mode) for possible values that can be returned.
...
Get the flash modes supported by the camera device currently started. Returns an array containing supported flash modes. See [FLASH_MODE](#flash_mode) for possible values that can be returned.
...
Set the flash mode. See [FLASH_MODE](#flash_mode) for details about the possible values.
...
Get the flash mode for the camera device currently started. Returns a string representing the current flash mode. See [FLASH_MODE](#flash_mode) for possible values that can be returned.
...
Get color modes supported by the camera device currently started. Returns an array containing supported color effects (strings). See [COLOR_EFFECT](#color_effect) for possible values that can be returned.
...
Set the color effect. See [COLOR_EFFECT](#color_effect) for details about the possible values for colorEffect.
...
Returns an array with supported white balance modes for the camera device currently started. See [WHITE_BALANCE_MODE](#white_balance_mode) for details about the possible values returned.
...
Get the curent white balance mode of the camera device currently started. See [WHITE_BALANCE_MODE](#white_balance_mode) for details about the possible values returned.
...
Set the white balance mode for the camera device currently started. See [WHITE_BALANCE_MODE](#white_balance_mode) for details about the possible values for whiteBalanceMode.
...
Returns an array with supported exposure modes for the camera device currently started. See [EXPOSURE_MODE](#exposure_mode) for details about the possible values returned.
...
Get the curent exposure mode of the camera device currently started. See [EXPOSURE_MODE](#exposure_mode) for details about the possible values returned.
...
Set the exposure mode for the camera device currently started. See [EXPOSURE_MODE](#exposure_mode) for details about the possible values for exposureMode.
...
Get the characteristics of all available cameras. Returns a JSON object representing the features from all available cameras.
...
Refer to <a href="https://github.com/cordova-plugin-camera-preview/cordova-plugin-camera-preview-sample-app">cordova-plugin-camera-preview-sample-app</a> for a complete working Cordova example for Android and iOS platforms. Pre-compiled Android APK demo app can be found [here](https://www.andreszsogon.com/cordova-camera-preview-plugin-demo/ "here").

# Screenshots

<img src="https://github.com/andreszs/cordova-plugin-demos/blob/main/com.andreszs.camera.preview.demo/screenshots/android/camera.preview.demo.2.jpg?raw=true" width="240" /> <img src="https://github.com/andreszs/cordova-plugin-demos/blob/main/com.andreszs.camera.preview.demo/screenshots/android/camera.preview.demo.3.jpg?raw=true" width="240" />
